    ...
    internal sealed class LogixLogger : ILogixLogger
    {
        ...
        void ILogixExceptionLogger.LogException(LogixLogError payLoad)
        {
            LogixLogException logixLogException = new LogixLogException
            {
                ...
                ClientIPAddress = System.Environment.MachineName,//System.Net.Dns.GetHostAddresses(System.Environment.MachineName).ToString(),
        ...
        {
            System.Web.HttpContextBase context = (System.Web.HttpContextBase)httpContext;
            ...
            LogixLogException logixLogException = new LogixLogException
            {
                ...
                ApplicationPool = null,
                //ClientIPAddress = context.Request.Connection.RemoteIpAddress.ToString(),
